...
export const RESEARCH_SYSTEM_PROMPT = [
  ...
  "",
  "Only report a contact whose role plausibly involves events, bookings, marketing, partnerships, sponsorships, press/media, or general office/front-desk correspondence (including a bare organizational address like info@/office@/contact@ with no named role at all). If a page lists many staff/officials, omit anyone whose stated role is clearly about an unrelated core operational function of the organization — e.g. a sports venue's on-field officials (a racecourse's handicapper, starter, stewards), a hospital's clinical staff, a school's academic faculty. A real, correctly-copied email for the wrong department is not useful and should not be reported — only pull contacts a person could plausibly pitch creative/event work to.",
  "",
